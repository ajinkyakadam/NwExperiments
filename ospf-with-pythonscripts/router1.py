...
try:
    ...
    log_fileName = open('/tmp/router1log', 'w')
    ...
    if index1 == 0:
        ...
        if index2 == 0:
            ...
            child.sendline('configure terminal')
            child.expect('.+#')
            child.sendline('enable password router1')
            child.expect('.+#')
