...
try:
    ...
    log_fileName = open('/tmp/routerDbgplog', 'w')
    ...
    if index1 == 0:
        ...
        child.expect('.+#')
        child.sendline('network 10.1.4.0 mask 255.255.255.252')
        child.expect('.+#')
        child.sendline('network 10.1.5.0 mask 255.255.255.0')
        child.expect('.+#')
        child.sendline('neighbor 10.1.4.1 remote-as 65200')
        child.expect('.+#')
        child.sendline('exit')
        child.expect('.+#')
        child.sendline('exit')
